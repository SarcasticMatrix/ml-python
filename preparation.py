...
def do_the_job(
    ...
    - `gridSearch` (bool,optionnel): Booléen pour effectuer un grid search cv lors de l'utilisation du RnadomForestClassifier pour 'education' (par défaut, les valeurs choisies sont les optimales)
